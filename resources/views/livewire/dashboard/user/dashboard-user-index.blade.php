            ...
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div class="place-self-center lg:col-span-12 text-center">
                    ...
                    <p class="max-w-3xl my-6 font-light text-gray-500 lg:mb-4 md:text-lg lg:text-xl dark:text-gray-400">
                        ...
                        books. We have a large collection of new and used books. We have new books in excellent condition as
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-6 px-4 mx-auto max-w-screen-xl sm:py-8 lg:px-6 flex items-center justify-between">
                <div class="max-w-screen-sm">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white ">The Latest Book
                        Updates</h2>
                    <p class="mb-8 font-light text-gray-500 sm:text-xl dark:text-gray-400 ">We have a wide selection of
                        books that you can choose from. We have new books in excellent condition as well as used books in
            ...
            <div class="py-6 px-4 mx-auto max-w-screen-xl sm:py-8 lg:px-6 flex items-center justify-between">
                ...
                <div class="max-w-screen-sm">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Various Kinds of
                        Genres </h2>
                    <p class="mb-8 font-light text-gray-500 sm:text-xl dark:text-gray-400">The NF Store has a vast selection
        ...
        <section class="bg-gray-100 dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div class="max-w-screen-md mb-8 lg:mb-16">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white ">NF Store Features
                    </h2>
